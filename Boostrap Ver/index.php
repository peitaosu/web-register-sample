...
<form class="form" id="mainForm" name="mainForm" method="post" action="" onSubmit="return chk(this)" runat="server">
  <table class="table">
  	<tbody>
  	<tr>
  		<td>User Name</td>
    		<td><input class="form-control" type="text" name="user_user" id="user_user" placeholder="Username"></td>
    	</tr>
  	<tr>
  		<td>Password</td>
    		<td><input class="form-control" name="user_password" type="password" id="user_password" placeholder="Password"></td>
    	</tr>
  	<tr>
  		<td>Re-enter the password</td>
    		<td><input class="form-control" name="pass" type="password" id="pass"  placeholder="Password"></td>
    	</tr>
  	<tr>
  		<td>Real Name</td>
    		<td><input class="form-control" type="text" name="user_name" id="user_name" placeholder="Real Name"></td>
    	</tr>
  	<tr>
  		<td>Sex</td>
  	...
  	<tr>
  		<td>Phone</td>
    		<td><input class="form-control" type="text" name="user_phone" id="user_phone" placeholder="Phone"></td>
	</tr>
	<tr>
  		<td>E-mail</td>
    		<td><input class="form-control" type="text" name="user_email" id="user_email" placeholder="E-mail"></td>
	</tr>
	<tr>
  		<td>Skills</td>
...
<form  class="form" action="" method="post" name="regForm" onSubmit="return Checklogin();" >
	<table class="table">
		<tbody>
		<tr>
			<td>Login</td>
		...
		<tr>
			<td><button  class="btn btn-primary" name="Login" type="submit" value="Login"/>Login</button></td>
